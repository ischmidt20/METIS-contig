          ...
          idx_t *part, idx_t *contigadjncy)
{
  ...
  if (ctrl->dbglvl&512)
    ...
    *objval = (*nparts == 1 ? 0 : MlevelKWayPartitioning(ctrl, graph, part, contigadjncy));
...
*/
/*************************************************************************/
idx_t MlevelKWayPartitioning(ctrl_t *ctrl, graph_t *graph, idx_t *part, idx_t *contigadjncy)
{
